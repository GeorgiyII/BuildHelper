...
class Ui_scan(object):
    def setupUi(self, scan):
        ...
        self.img1_1.setGeometry(QtCore.QRect(290, 30, 200, 120))
        self.img1_1.setText("")
        self.img1_1.setIcon(QtGui.QIcon('image/scan/img1_1.png'))
        self.img1_1.setIconSize(QtCore.QSize(190, 300))
        ...
        self.img2_2.setGeometry(QtCore.QRect(290, 175, 200, 120))
        self.img2_2.setText("")
        self.img2_2.setIcon(QtGui.QIcon('image/scan/img2_2.png'))
        self.img2_2.setIconSize(QtCore.QSize(200, 300))
        ...
        self.img2_3.setGeometry(QtCore.QRect(290, 320, 200, 120))
        self.img2_3.setText("")
        self.img2_3.setIcon(QtGui.QIcon('image/scan/img3_3.png'))
        self.img2_3.setIconSize(QtCore.QSize(190, 300))
        ...
        self.listWidget.setGeometry(QtCore.QRect(500, 35, 110, 400))
